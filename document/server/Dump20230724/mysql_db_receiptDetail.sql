...
CREATE TABLE `receiptDetail` (
  ...
  CONSTRAINT `receiptDetail_ibfk_1` FOREIGN KEY (`receiptId`) REFERENCES `receipt` (`id`),
  CONSTRAINT `receiptDetail_ibfk_2` FOREIGN KEY (`productId`) REFERENCES `products` (`id`)
