...
CREATE TABLE `addressUser` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `addressUser_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
INSERT INTO `addressUser` VALUES (1,'Nguyen Hieu 1','123456 Balewadi, Pune','abc@gmail.com','123456789',NULL,NULL,NULL);
...
-- Dump completed on 2023-07-24 14:57:39
